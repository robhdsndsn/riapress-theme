...
export default function save({ attributes }) {
	...
	const blockProps = useBlockProps.save({
		className: `ria-contact-info layout-${layout} align-${alignment} font-${fontSize} icon-${iconStyle} icon-pos-${iconPosition} variant-${variant} box-shadow-${boxShadow} hover-shadow-${hoverShadow} hover-animation-${hoverAnimation}`,
		style: {
			...(variant === 'custom' ? {
			...
			<div className="contact-items">
				{showPhone && phone && (
					<div className="contact-item">
						{showIcons && (
							<span className="contact-icon" dangerouslySetInnerHTML={{ __html: icons.phone }} />
						)}
						<div className="contact-content">
							{showLabels && <span className="contact-label">{phoneLabel}</span>}
							{clickablePhone ? (
								<a href={`tel:${formatPhoneForTel(phone)}`} className="contact-value contact-link">
									{phone}
								</a>
							) : (
				...
				{showEmail && email && (
					<div className="contact-item">
						{showIcons && (
							<span className="contact-icon" dangerouslySetInnerHTML={{ __html: icons.mail }} />
						)}
						<div className="contact-content">
				...
				{showAddress && address && (
					<div className="contact-item">
						{showIcons && (
							<span className="contact-icon" dangerouslySetInnerHTML={{ __html: icons.mapPin }} />
						)}
						<div className="contact-content">
				...
				{showWebsite && website && (
					<div className="contact-item">
						{showIcons && (
							<span className="contact-icon" dangerouslySetInnerHTML={{ __html: icons.globe }} />
						)}
						<div className="contact-content">
							{showLabels && <span className="contact-label">{websiteLabel}</span>}
							<a href={website} className="contact-value contact-link" target="_blank" rel="noopener noreferrer">
								{website}
							</a>
						</div>
					</div>
				...
				{showFax && fax && (
					<div className="contact-item">
						{showIcons && (
							<span className="contact-icon" dangerouslySetInnerHTML={{ __html: icons.printer }} />
						)}
						<div className="contact-content">
