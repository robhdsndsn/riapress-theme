...
<PanelBody title={__('Color Scheme', 'ria-person-profile')} initialOpen={true}>
  <SelectControl
    label={__('Variant', 'ria-person-profile')}
    value={variant}
    options={[
      { label: __('Primary (Navy)', 'ria-person-profile'), value: 'primary' },
      { label: __('Secondary (Green)', 'ria-person-profile'), value: 'secondary' },
      { label: __('Tertiary (Orange)', 'ria-person-profile'), value: 'tertiary' },
      { label: __('Neutral (Gray)', 'ria-person-profile'), value: 'neutral' },
      { label: __('Custom', 'ria-person-profile'), value: 'custom' }
    ]}
    onChange={(value) => setAttributes({ variant: value })}
    help={__('Choose a color scheme or use custom colors', 'ria-person-profile')}
  />
</PanelBody>

{variant === 'custom' && (
  <PanelColorSettings
    title={__('Custom Colors', 'ria-person-profile')}
    colorSettings={[
      {
        value: customBackgroundColor,
        onChange: (color) => setAttributes({ customBackgroundColor: color }),
        label: __('Background Color', 'ria-person-profile')
      },
      {
        value: customBorderColor,
        onChange: (color) => setAttributes({ customBorderColor: color }),
        label: __('Border Color', 'ria-person-profile')
      }
    ]}
  />
)}
